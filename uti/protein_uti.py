...
def run_fpocket(protein_list, input_file, output_name):
    ...
    for protein in protein_list:
        ...
        clean_pdb(input_path=f"{data_dir}/{input_file}",
                  pdbid=f"{protein}.pdb")
        # run FPocket without chain selection option: -k
        os.system(f"fpocket -f {data_dir}/{input_file}/{protein}_cleaned.pdb")
